...
окно останется открытым с понятной причиной. На macOS он также сам откроет
Docker Desktop и ждёт готовности до двух минут. На Windows Docker Desktop пока
нужно открыть и дождаться статуса Running вручную. Однократно до первого
