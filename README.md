...
- WT-659 фиксирует воспроизводимый preview build после WT-658: DMG/NSIS прошли install smoke на macOS Intel, Apple Silicon и Windows.
...
- [WT-659 desktop preview evidence](docs/WT-659_DESKTOP_PREVIEW_EVIDENCE.md)
