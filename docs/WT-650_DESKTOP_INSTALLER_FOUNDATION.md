...
22 июля 2026 года preview workflow после WT-658 успешно повторил этот smoke
для macOS Intel, macOS Apple Silicon и Windows NSIS. Точные artifact names,
размеры, source commit и сохраняющиеся ограничения зафиксированы в
[WT-659 desktop preview evidence](WT-659_DESKTOP_PREVIEW_EVIDENCE.md).
